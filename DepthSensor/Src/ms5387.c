...
void prom(void)
{
    ...
    HAL_I2C_Master_Transmit(&hi2c1,Address,reset,1,50);
    HAL_Delay(50);
    ...
    {
        prom_ad[0] = 0xA2 + (2 * i);
        HAL_I2C_Master_Transmit(&hi2c1,Address,prom_ad,1,50);
        HAL_I2C_Master_Receive(&hi2c1,Address,data,2,50);
...
void convert(void)
{
    ...
    HAL_I2C_Master_Transmit(&hi2c1,Address,d1,1,50);
    HAL_Delay(50);
    HAL_I2C_Master_Transmit(&hi2c1,Address,adc,1,50);
    HAL_Delay(50);
    HAL_I2C_Master_Receive(&hi2c1,Address,crc,3,50);

    D1 = ((crc[0] * 65536.0) + (crc[1] * 256.0) + crc[2]);

    HAL_I2C_Master_Transmit(&hi2c1,Address,d2,1,50);
    HAL_Delay(50);
